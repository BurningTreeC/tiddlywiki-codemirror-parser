/*\
title: $:/plugins/BurningTreeC/tiddlywiki-codemirror/lib/codemirror-autocomplete.js
...
*/
const pickedCompletion = /*@__PURE__*/state.Annotation.define();
/**
...
const startCompletionEffect = /*@__PURE__*/state.StateEffect.define();
const closeCompletionEffect = /*@__PURE__*/state.StateEffect.define();
...
const completionConfig = /*@__PURE__*/state.Facet.define({
    combine(configs) {
...
const setActiveEffect = /*@__PURE__*/state.StateEffect.define({
    map(sources, mapping) { return sources.map(s => s.map(mapping)); }
});
const setSelectedEffect = /*@__PURE__*/state.StateEffect.define();
const completionState = /*@__PURE__*/state.StateField.define({
...
const completionPlugin = /*@__PURE__*/view.ViewPlugin.fromClass(class {
    constructor(view) {
        this.view = view;
...
const commitCharacters = /*@__PURE__*/state.Prec.highest(/*@__PURE__*/view.EditorView.domEventHandlers({
    keydown(event, view) {
...
let fieldMarker = /*@__PURE__*/view.Decoration.widget({ widget: /*@__PURE__*/new class extends view.WidgetType {
        toDOM() {
...
let fieldRange = /*@__PURE__*/view.Decoration.mark({ class: "cm-snippetField" });
class ActiveSnippet {
...
const setActive = /*@__PURE__*/state.StateEffect.define({
    map(value, changes) { return value && value.map(changes); }
});
const moveToField = /*@__PURE__*/state.StateEffect.define();
const snippetState = /*@__PURE__*/state.StateField.define({
    create() { return null; },
    update(value, tr) {
        for (let effect of tr.effects) {
...
*/
const snippetKeymap = /*@__PURE__*/state.Facet.define({
    combine(maps) { return maps.length ? maps[0] : defaultSnippetKeymap; }
});
const addSnippetKeymap = /*@__PURE__*/state.Prec.highest(/*@__PURE__*/view.keymap.compute([snippetKeymap], state => state.facet(snippetKeymap)));
/**
...
const snippetPointerHandler = /*@__PURE__*/view.EditorView.domEventHandlers({
...
const closeBracketEffect = /*@__PURE__*/state.StateEffect.define({
    map(value, mapping) {
        let mapped = mapping.mapPos(value, -1, state.MapMode.TrackAfter);
        return mapped == null ? undefined : mapped;
    }
});
const closedBracket = /*@__PURE__*/new class extends state.RangeValue {
};
closedBracket.startSide = 1;
closedBracket.endSide = -1;
const bracketState = /*@__PURE__*/state.StateField.define({
...
const inputHandler = /*@__PURE__*/view.EditorView.inputHandler.of((view, from, to, insert) => {
...
const completionKeymapExt = /*@__PURE__*/state.Prec.highest(/*@__PURE__*/view.keymap.computeN([completionConfig], state => state.facet(completionConfig).defaultKeymap ? [completionKeymap] : []));
/**
