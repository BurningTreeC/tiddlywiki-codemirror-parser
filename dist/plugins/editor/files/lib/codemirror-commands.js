/*\
title: $:/plugins/BurningTreeC/tiddlywiki-codemirror/lib/codemirror-commands.js
...
const fromHistory = /*@__PURE__*/state.Annotation.define();
/**
...
*/
const isolateHistory = /*@__PURE__*/state.Annotation.define();
/**
...
*/
const invertedEffects = /*@__PURE__*/state.Facet.define();
const historyConfig = /*@__PURE__*/state.Facet.define({
    combine(configs) {
...
const historyField_ = /*@__PURE__*/state.StateField.define({
    create() {
