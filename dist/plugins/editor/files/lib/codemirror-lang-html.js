/*\
title: $:/plugins/BurningTreeC/tiddlywiki-codemirror/lib/codemirror-lang-html.js
...
const htmlHighlighting = highlight.styleTags({
  "Text RawText IncompleteTag IncompleteCloseTag": highlight.tags.content,
...
const VariablesByNode = /*@__PURE__*/new common.NodeWeakMap();
...
*/
const cssLanguage = /*@__PURE__*/language.LRLanguage.define({
    name: "css",
...
const cache = /*@__PURE__*/new common.NodeWeakMap();
...
highlighting and indentation information.
*/
const javascriptLanguage = /*@__PURE__*/language.LRLanguage.define({
    name: "javascript",
...
const jsxLanguage = /*@__PURE__*/javascriptLanguage.configure({
    dialect: "jsx",
    props: [/*@__PURE__*/language.sublanguageProp.add(n => n.isTop ? [jsxSublanguage] : undefined)]
});
/**
...
`/` is typed.
*/
const autoCloseTags$1 = /*@__PURE__*/view.EditorView.inputHandler.of((view, from, to, text, defaultInsert) => {
    ...
    let closeTags = state$1.changeByRange(range => {
        ...
        if (state$1.doc.sliceString(head - 1, head) != text || around.name == "JSXAttributeValue" && around.to > head) ;
            ...
            if (base && empty.from == head - 2 &&
                ((name = elementName$1(state$1.doc, base.firstChild, head)) || ((_a = base.firstChild) === null || _a === void 0 ? void 0 : _a.name) == "JSXFragmentTag")) {
                let insert = `${name}>`;
            ...
            if (openTag && openTag.name == "JSXOpenTag" &&
                ...
                (name = elementName$1(state$1.doc, openTag, head)))
...
const htmlPlain = /*@__PURE__*/language.LRLanguage.define({
    name: "html",
...
`/` is typed.
*/
const autoCloseTags = /*@__PURE__*/view.EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
