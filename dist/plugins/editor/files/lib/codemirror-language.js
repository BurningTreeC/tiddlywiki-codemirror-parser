/*\
title: $:/plugins/BurningTreeC/tiddlywiki-codemirror/lib/codemirror-language.js
...
*/
const languageDataProp = /*@__PURE__*/new common.NodeProp();
/**
...
*/
const sublanguageProp = /*@__PURE__*/new common.NodeProp();
/**
...
@internal
*/
Language.setState = /*@__PURE__*/state.StateEffect.define();
...
Language.state = /*@__PURE__*/state.StateField.define({
...
const parseWorker = /*@__PURE__*/view.ViewPlugin.fromClass(class ParseWorker {
    constructor(view) {
        this.view = view;
        this.working = null;
...
*/
const language = /*@__PURE__*/state.Facet.define({
...
*/
const indentNodeProp = /*@__PURE__*/new common.NodeProp();
...
can be found.
*/
const foldService = /*@__PURE__*/state.Facet.define();
/**
...
when it is.
*/
const foldNodeProp = /*@__PURE__*/new common.NodeProp();
/**
...
*/
const foldEffect = /*@__PURE__*/state.StateEffect.define({ map: mapRange });
/**
State effect that unfolds the given range (if it was folded).
*/
const unfoldEffect = /*@__PURE__*/state.StateEffect.define({ map: mapRange });
...
state.
*/
const foldState = /*@__PURE__*/state.StateField.define({
    create() {
...
const foldConfig = /*@__PURE__*/state.Facet.define({
...
const foldWidget = /*@__PURE__*/view.Decoration.replace({ widget: /*@__PURE__*/new class extends view.WidgetType {
...
const highlighterFacet = /*@__PURE__*/state.Facet.define();
const fallbackHighlighter = /*@__PURE__*/state.Facet.define({
...
const treeHighlighter = /*@__PURE__*/state.Prec.high(/*@__PURE__*/view.ViewPlugin.fromClass(TreeHighlighter, {
...
const bracketMatchingConfig = /*@__PURE__*/state.Facet.define({
    combine(configs) {
...
const matchingMark = /*@__PURE__*/view.Decoration.mark({ class: "cm-matchingBracket" }), nonmatchingMark = /*@__PURE__*/view.Decoration.mark({ class: "cm-nonmatchingBracket" });
...
const bracketMatchingState = /*@__PURE__*/state.StateField.define({
...
place.
*/
const bracketMatchingHandle = /*@__PURE__*/new common.NodeProp();
...
const nodeSet = /*@__PURE__*/new common.NodeSet(typeArray);
const warned = [];
...
function createTokenType(extra, tagStr) {
    ...
    let type = byTag[key] = common.NodeType.define({
        id: typeArray.length,
        name,
        props: [highlight.styleTags({ [name]: tags$1 })]
    });
    typeArray.push(type);
    return type.id;
}
...
const alwaysIsolate = /*@__PURE__*/state.Facet.define({ combine: values => values.some(x => x) });
/**
Make sure nodes
...
const isolateMarks = /*@__PURE__*/view.ViewPlugin.fromClass(class {
    constructor(view$1) {
...
const marks = {
    rtl: /*@__PURE__*/view.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "rtl" }, bidiIsolate: view.Direction.RTL }),
    ltr: /*@__PURE__*/view.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "ltr" }, bidiIsolate: view.Direction.LTR }),
    auto: /*@__PURE__*/view.Decoration.mark({ class: "cm-iso", inclusive: true, attributes: { dir: "auto" }, bidiIsolate: null })
};
