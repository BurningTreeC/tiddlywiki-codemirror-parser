/*\
title: $:/plugins/BurningTreeC/tiddlywiki-codemirror/lib/codemirror-view.js
...
*/
exports.BlockType = /*@__PURE__*/(function (BlockType) {
    /**
    A line of text.
    */
...
return BlockType})(exports.BlockType || (exports.BlockType = {}));
/**
...
*/
exports.Direction = /*@__PURE__*/(function (Direction) {
...
return Direction})(exports.Direction || (exports.Direction = {}));
...
const clickAddsSelectionRange = /*@__PURE__*/state.Facet.define();
const dragMovesSelection$1 = /*@__PURE__*/state.Facet.define();
const mouseSelectionStyle = /*@__PURE__*/state.Facet.define();
const exceptionSink = /*@__PURE__*/state.Facet.define();
const updateListener = /*@__PURE__*/state.Facet.define();
const inputHandler = /*@__PURE__*/state.Facet.define();
const focusChangeEffect = /*@__PURE__*/state.Facet.define();
const clipboardInputFilter = /*@__PURE__*/state.Facet.define();
const clipboardOutputFilter = /*@__PURE__*/state.Facet.define();
const perLineTextDirection = /*@__PURE__*/state.Facet.define({
    combine: values => values.some(x => x)
});
const nativeSelectionHidden = /*@__PURE__*/state.Facet.define({
    combine: values => values.some(x => x)
});
const scrollHandler = /*@__PURE__*/state.Facet.define();
class ScrollTarget {
...
const scrollIntoView = /*@__PURE__*/state.StateEffect.define({ map: (t, ch) => t.map(ch) });
const setEditContextFormatting = /*@__PURE__*/state.StateEffect.define();
/**
...
const editable = /*@__PURE__*/state.Facet.define({ combine: values => values.length ? values[0] : true });
let nextPluginID = 0;
const viewPlugin = /*@__PURE__*/state.Facet.define({
    combine(plugins) {
...
const editorAttributes = /*@__PURE__*/state.Facet.define();
const contentAttributes = /*@__PURE__*/state.Facet.define();
// Provide decorations
const decorations = /*@__PURE__*/state.Facet.define();
const blockWrappers = /*@__PURE__*/state.Facet.define();
const outerDecorations = /*@__PURE__*/state.Facet.define();
const atomicRanges = /*@__PURE__*/state.Facet.define();
const bidiIsolatedRanges = /*@__PURE__*/state.Facet.define();
...
const scrollMargins = /*@__PURE__*/state.Facet.define();
...
const styleModule = /*@__PURE__*/state.Facet.define();
class ChangedRange {
...
const isFocusChange = /*@__PURE__*/state.Annotation.define();
...
const theme = /*@__PURE__*/state.Facet.define({ combine: strs => strs.join(" ") });
const darkTheme = /*@__PURE__*/state.Facet.define({ combine: values => values.indexOf(true) > -1 });
...
*/
EditorView.cspNonce = /*@__PURE__*/state.Facet.define({ combine: values => values.length ? values[0] : "" });
/**
...
search match).
*/
EditorView.announce = /*@__PURE__*/state.StateEffect.define();
...
const handleKeyEvents = /*@__PURE__*/state.Prec.default(/*@__PURE__*/EditorView.domEventHandlers({
    keydown(event, view) {
...
*/
const keymap = /*@__PURE__*/state.Facet.define({ enables: handleKeyEvents });
...
const layerOrder = /*@__PURE__*/state.Facet.define();
/**
Define a layer.
*/
...
const selectionConfig = /*@__PURE__*/state.Facet.define({
    combine(configs) {
...
const hideNativeSelection = /*@__PURE__*/state.Prec.highest(/*@__PURE__*/EditorView.theme({
    ".cm-line": {
...
const setDropCursorPos = /*@__PURE__*/state.StateEffect.define({
    map(pos, mapping) { return pos == null ? null : mapping.mapPos(pos); }
});
const dropCursorPos = /*@__PURE__*/state.StateField.define({
    create() { return null; },
    update(pos, tr) {
        if (pos != null)
...
const specialCharConfig = /*@__PURE__*/state.Facet.define({
    combine(configs) {
...
const tooltipConfig = /*@__PURE__*/state.Facet.define({
    combine: values => {
        var _a, _b, _c;
        return ({
...
*/
const showTooltip = /*@__PURE__*/state.Facet.define({
    enables: [tooltipPlugin, baseTheme]
});
const showHoverTooltip = /*@__PURE__*/state.Facet.define({
...
const closeHoverTooltipEffect = /*@__PURE__*/state.StateEffect.define();
/**
...
const openDialogEffect = /*@__PURE__*/state.StateEffect.define();
const closeDialogEffect = /*@__PURE__*/state.StateEffect.define();
...
*/
const gutterLineClass = /*@__PURE__*/state.Facet.define();
/**
Facet used to add a class to all gutter elements next to a widget.
Should not provide widgets with a `toDOM` method.
*/
const gutterWidgetClass = /*@__PURE__*/state.Facet.define();
const defaults = {
    class: "",
...
const activeGutters = /*@__PURE__*/state.Facet.define();
/**
...
const unfixGutters = /*@__PURE__*/state.Facet.define({
    combine: values => values.some(x => x)
});
/**
...
*/
const lineNumberMarkers = /*@__PURE__*/state.Facet.define();
/**
Facet used to create markers in the line number gutter next to widgets.
*/
const lineNumberWidgetMarker = /*@__PURE__*/state.Facet.define();
const lineNumberConfig = /*@__PURE__*/state.Facet.define({
    combine(values) {
...
const activeLineGutterHighlighter = /*@__PURE__*/gutterLineClass.compute(["selection"], state$1 => {
    let marks = [], last = -1;
