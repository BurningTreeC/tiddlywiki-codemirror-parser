 ...
 */
export function generalContextCompletion(getTiddlerTitles, getMacroNames, getWidgetNames, getFunctionNames, getVariableNames, isDraftTiddler) {
    return (context) => {
        ...
        if (isInSpecificContext(textBefore))
            return null;
