 ...
 */
function getMergedAttributes(tagName) {
 ...
 */
export function htmlTagCompletion(context) {
 ...
 */
export function htmlAttributeCompletion(getCSSProperties) {
    return (context) => {
        const { state, pos } = context;
