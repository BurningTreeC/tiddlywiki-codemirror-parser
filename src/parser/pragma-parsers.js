 ...
 */
function createPragmaHeader(pragmaStart, text, keyword, name, paramStr) {
 ...
 * All pragma parsers
 */
export const DefaultPragmaParsers = [
    MacroDefPragma,
    FnProcDefPragma,
    RulesPragma,
    ImportPragma,
...
//# sourceMappingURL=pragma-parsers.js.map